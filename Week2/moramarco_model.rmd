...
### Understanding Correlation of Sales by Sandwich Type

```{r}
cor(sales.data[,2:4])
```

### Developing Probability Density Functions by Sandwich Type
...
### Understanding the Cost/Benefit for Inventory Levels
